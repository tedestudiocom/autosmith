    ...
    <footer className="bg-secondary px-8 py-2 gap-12 flex flex-col w-full justify-between items-center relative text-white">
      ...
      <div className="flex w-full justify-between py-14">
        <div className="w-full flex flex-col gap-2">
          ...
          <ul className="flex flex-col gap-2">
            <li>
              <a href="/about">About Autosmith</a>
            </li>
            <li>
            ...
            <li>
              <a href="/costsheet.xml">Costsheet</a>
            </li>
          </ul>
        </div>
        <div className="w-full flex flex-col gap-2">
          ...
          <ul className="flex flex-col gap-2">
            ...
            <li>
              <a href="/refunds">Partner Policy</a>
            </li>
          </ul>
        </div>
        <div className="w-full flex flex-col gap-2">
          <h5 className="text-2xl font-[600]">Partners</h5>
          <ul className="flex flex-col gap-2">
            <li>
              <a href="/terms">Funding Deck</a>
            </li>
            <li>
              <a href="/privacy">Investor Relations</a>
            </li>
            <li>
              <a href="/refunds">Careers</a>
            </li>
            <li>
              <a href="/refunds">Partner with us</a>
            </li>
          </ul>
        </div>
        <div className="w-full flex flex-col gap-2">
      ...
      <div className="text-center">
        <p className="text-white">
          © Autosmith 2025. Autosmith™ is a registered trademark of Autosmith
          Garages, LLC.
        </p>
      </div>
    </footer>
